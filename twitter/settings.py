...
DATABASES = {
    'default': {
        ...
        'PORT': '3306',
        'USER': 'root',
        'PASSWORD': 'yourpassword',    # The password you set when downloading mysql
    }
}
...
# set storage system to save uploaded photos
...
AWS_STORAGE_BUCKET_NAME = 'twitter-webapp'
AWS_S3_REGION_NAME = 'us-west-1'

# when testing, photos will be saved here
MEDIA_ROOT = 'media/'
...
# Redis
# Install Method: sudo apt-get install redis
# Then install python client for redis： pip install redis
